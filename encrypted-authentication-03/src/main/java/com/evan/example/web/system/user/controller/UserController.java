...
public class UserController {
    ...
    public String hello(@SessionAttribute(value = "hairCutMaster", required = false) String hairCutMaster, @RequestParam(name = "name", defaultValue = "unknown user") String name) {
