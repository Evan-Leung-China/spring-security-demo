...
import com.evan.example.web.system.authentication.KaltAuthenticationManager;
import com.evan.example.web.system.authentication.UserMapperRememberMeServices;
...
public class SecurityConfig {
    ...
    @Autowired
    private KaltAuthenticationManager kaltAuthenticationManager;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.setSharedObject(AuthenticationManager.class, kaltAuthenticationManager);
...
//                .rememberMe(customizer -> customizer.rememberMeServices(rememberMeServices))
    ...
    private void initAuthenticationController(HttpSecurity http) {
        ...
        this.authenticationController.setAuthenticationManager(kaltAuthenticationManager);
